...
## Descriptions
- Removes all standard AOSP system soundfx (except proxy, visualizer, and downmix). Makes your audio mod sounds clearer. AOSP soundfx is exist in all ROM and vendor, not only in AOSP based ROM.
